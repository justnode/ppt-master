...
Usage:
    ...
    uv run python3 scripts/finalize_svg.py <project_directory>

    # Execute only specific steps
    uv run python3 scripts/finalize_svg.py <project_directory> --only embed-icons fix-rounded

Examples:
    uv run python3 scripts/finalize_svg.py projects/my_project
