...
Usage:
    uv run python3 scripts/svg_finalize/fix_image_aspect.py <svg_file> [svg_file2] ...
    uv run python3 scripts/svg_finalize/fix_image_aspect.py projects/xxx/svg_output/*.svg

    # Preview mode
    uv run python3 scripts/svg_finalize/fix_image_aspect.py --dry-run projects/xxx/svg_output/*.svg

Examples:
    uv run python3 scripts/svg_finalize/fix_image_aspect.py projects/demo/svg_output/slide_06_current_overview.svg
"""
